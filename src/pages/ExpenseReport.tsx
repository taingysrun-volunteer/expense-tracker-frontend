...
import { CategoryBreakdown, SummaryResponse } from "../models/Report";
import { Category } from "../models/Category";


export default function ExpenseReport(): JSX.Element {
    ...
    const generateBarChart = (monthlyData: SummaryResponse['monthlyBreakdown']) => {
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div style={styles.statsGrid}>
                            ...
                            <div style={styles.statCard}>
                                <div style={styles.statContent}>
                                    <div style={styles.statLabel}>Max Amount</div>
                                    <div style={styles.statValue}>{formatCurrency(summary.maxAmount)}</div>
                                </div>
                            </div>

                            <div style={styles.statCard}>
                                <div style={styles.statContent}>
                                    <div style={styles.statLabel}>Min Amount</div>
                                    <div style={styles.statValue}>{formatCurrency(summary.minAmount)}</div>
                                </div>
                            </div>
                        </div>
                                ...
                                {summary.categoryBreakdown.length === 0 ? (
                                    ...
                                    <>
                                        ...
                                        {summary.categoryBreakdown.length === 1 && (
                                            <div style={styles.singleCategoryInfo}>
                                                Showing data for: <strong>{summary.categoryBreakdown[0].categoryName}</strong>
                                            </div>
                                        )}
